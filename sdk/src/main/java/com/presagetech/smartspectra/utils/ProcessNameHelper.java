...
// from https://github.com/Blankj/AndroidUtilCode/blob/master/lib/utilcode/src/main/java/com/blankj/utilcode/util/ProcessUtils.java
public class ProcessNameHelper {
    public static String getCurrentProcessName(Context appContext) {
        String name = getCurrentProcessNameByFile();
        if (!TextUtils.isEmpty(name)) return name;
        name = getCurrentProcessNameByAms(appContext);
        if (!TextUtils.isEmpty(name)) return name;
        name = getCurrentProcessNameByReflect(appContext);
        return name;
    }
